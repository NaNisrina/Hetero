    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php
          ...
          header("refresh:3;url=guru.php"); //3 detik refresh
        ...
        <?php
          ...
          header("refresh:3;url=guru.php"); //3 detik
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              ...
              <select class="form-control" name="mapel" id="mapel">
                ...
                <option value="5" <?php
                                      if ($mapel == "5") echo "selected"
                                    ?>> IPS </option>
                <option value="6" <?php
                                      if ($mapel == "6") echo "selected"
                                    ?>> IPA </option>
                <option value="7" <?php
                                      if ($mapel == "7") echo "selected"
                                    ?>> BAHASA </option>
                <option value="8" <?php
                                      if ($mapel == "8") echo "selected"
                                    ?>> MATEMATIKA </option>
                <option value="9" <?php
                                      if ($mapel == "9") echo "selected"
                                    ?>> RPL </option>
              </select>
            </div>
          </div>
      ...
      <div class="card-body">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <?php
              $sql2   = " SELECT kontak.id, kontak.email, 
                          kontak.nama, kontak.telp, idm.nama_mapel
                          FROM kontak
                          INNER JOIN idm 
                          ON kontak.mapel=idm.mapel;";
            ...
            ?>
              ...
              <tr>
                ...
                <td scope="row">
                  <a href="guru.php?op=edit&id=<?php echo $id ?>">
                    <button type="button" class="btn btn-warning">Edit</button>
                  </a>

                  <a href="guru.php?op=delete&id= <?php echo $id ?>">
